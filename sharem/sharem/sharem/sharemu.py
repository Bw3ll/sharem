...
def startEmu(data, vb):
    ...
    #outFile.close()    # temporary solution to https://github.com/Bw3ll/sharem/issues/56

    #stackFile.close()  # temporary solution to https://github.com/Bw3ll/sharem/issues/56
