...
class EMU(metaclass=Singleton):
    def __init__(self):
        ...
        self.maxLoop = 7000  # to break out of loops
        self.useBreakOutLifetimeLimit = False
        # self.breakLoopLifetimeLimit = 10000   ## if we go this many past the last time we had a breakout, we reset lifetime breakout
        self.maxMultiplier = 3
        self.entryOffset = 0
        self.entryOffset = 0
