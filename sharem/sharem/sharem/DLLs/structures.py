from ctypes import LittleEndianStructure, c_byte, c_char, c_double, c_float, c_int, c_long, c_longlong, c_short, c_uint, c_ulong, c_ulonglong, c_ushort, c_wchar, sizeof
...
LPCWSTR_32BIT = LPWSTR_32BIT = PWSTR_32BIT = c_ulong
LPCSTR_32BIT = LPSTR_32BIT = PSTR_32BIT = c_ulong
LPCVOID_32BIT = LPVOID_32BIT = PVOID_32BIT = c_ulong

# 64 Bit Pointers / Const Pointers
LPCWSTR_64BIT = LPWSTR_64BIT = PWSTR_64BIT = c_ulonglong
LPCSTR_64BIT = LPSTR_64BIT = PSTR_64BIT = c_ulonglong
LPCVOID_64BIT = LPVOID_64BIT = PVOID_64BIT = c_ulonglong

# Params 32 Bit 
WPARAM_32BIT = c_ulong
LPARAM_32BIT = c_long

# Params 64 Bit
WPARAM_64BIT = c_ulonglong
LPARAM_64BIT = c_longlong
...
# Handles 32 Bit
HANDLE_32BIT = c_ulong # Base Handle
...
# Handles 64 Bit
HANDLE_64BIT = c_ulonglong # Base Handle
