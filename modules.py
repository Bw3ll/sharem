...
LDR_ADVPACK_ADDR=0x11025300
LDR_BCRYPT_ADDR=0x11025600
LDR_CRYPT32_ADDR=0x11025900
LDR_DNSAPI_ADDR=0x11025C00
LDR_MPR_ADDR=0x11026000
LDR_NCRYPT_ADDR=0x11026300
LDR_NETUTILS_ADDR=0x11026600
LDR_SAMCLI_ADDR=0x11026900
LDR_SECUR32_ADDR=0x11026C00
LDR_WKSCLI_ADDR=0x11027000
LDR_WTSAPI32_ADDR=0x11027300
...
allDlls=["ntdll", "kernel32",  "advapi32",  "comctl32",  "comdlg32",  "gdi32",  "imm32",  "mscoree",  "msvcrt",  "netapi32",  "ole32",  "oleaut32",  "shell32",  "shlwapi",  "urlmon",  "user32",  "wininet",  "winmm",  "ws2_32",  "wsock32", "advpack", "bcrypt", "crypt32", "dnsapi", "mpr", "ncrypt", "netutils", "samcli", "secur32", "wkscli", "wtsapi32"]
